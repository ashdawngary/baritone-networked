...
public interface IBaritone {
     ...
     * @see IFarmProcess
     */
    IFarmProcess getFarmProcessNew();
  ...
  /**
   *
   * @return The {@link ICustomStrategyProcess} instance (for custom strats).
   * @see ICustomStrategyProcess
   */
  ICustomStrategyProcess getCustomStrategyProcess();
