...
public class Baritone implements IBaritone {
    ...
    Baritone() {
        ...
        this.pathingControlManager = new PathingControlManager(this);
        {
            ...
            this.pathingControlManager.registerProcess(fpNew = new FarmProcessNew(this));
            this.pathingControlManager.registerProcess(customStrategyProcess = new CustomStrategyProcess(this));
        }
    ...
    @Override
    public CustomStrategyProcess getCustomStrategyProcess() {
        return this.customStrategyProcess;
    }
    ...
    @Override
    public IFarmProcess getFarmProcessNew() {
        return this.fpNew;
    }
